				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="highlight">Recycle Dry waste</h2>
							...
							Home
								...
								<li class="active">Recycle Dry Waste</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-sm-7 col-md-8 col-lg-8">
							...
							<form action="drycomplaint.php" method="POST">
								...
								<fieldset>
								<legend>Recycle Dry Waste</legend>
								</fieldset>
								
BOOK DRY OR WET WASTE COLLECTION
URM can help find the most cost-effective solution based on your needs.
Arrange a wet and dry garbage collection for your home or business today.

Get rubbish removal prices or book a waste collection
...
Household junk
URM has a range of green and cost-effective solutions for your home or business. Hire a bin or skip, or have us collect and dispose of mixed dry waste for you.
							</form>
