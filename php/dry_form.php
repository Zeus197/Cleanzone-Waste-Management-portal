...
<!-- Mirrored from webdesign-finder.com/html/gogreen/blog-right.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 May 2018 04:44:30 GMT -->
<head>
							...
							<div class="header_mainmenu display_table_cell text-center">
								...
								<nav class="mainmenu_wrapper">
									<ul class="mainmenu nav sf-menu">
                                        ...
                                        <li>
													<a href="blog-mosaic.html">Helpline</a>
												</li>
											</ul>
										</li>
										<!-- eof blog -->
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-7 col-md-8 col-lg-8">
							...
							<form action="drycomplaint.php" method="POST">
						...
						<th><input type="submit" value="Complaint"></th>
								...
								<div class="item-content entry-content">
									...
									<span class="entry-date highlightlinks">
										...
										<h4 class="entry-title">
											<a href="blog-single-right.html" rel="bookmark">Waste Disposal."World of Earth Science."</a>
										</h4>
									...
									<p>Waste Management is the handling of discarded materials.Recycling and Composting, which transform waste into useful products, are forms of waste management.The management of waste also includes disposal such as landfilling </p>
							...
							<article class="post format-small-image with_background rounded">
								...
								<div class="side-item content-padding">
									...
									<div class="row">
										...
										<div class="col-md-5">
											<div class="item-media entry-thumbnail">
												<img src="images/gallery_square/14.png" alt="">
											</div>
										</div>
										...
										<!--	<span class="entry-date highlightlinks">
												...
												<p>Dry Waste is typically defined as any waste which will not rot or disintegrate over time and has little moisture content.To be cleaned and stored . Handed over to recyclers on regular intervals.</p>
							...
							<article class="vertical-item content-padding big-padding post format-gallery with_background rounded">
								...
								<div class="entry-thumbnail">
									<div class="owl-carousel" data-loop="true" data-margin="0" data-nav="false" data-dots="true" data-themeclass="entry-thumbnail-carousel" data-center="false" data-items="1" data-autoplay="true" data-responsive-xs="1" data-responsive-sm="1" data-responsive-md="1"
										...
										<div class="item">
											<img src="images/gallery_square/15.jpg" alt="image">
										</div>
										<div class="item">
											<img src="images/gallery_square/16.jpg" alt="image">
										</div>
										<div class="item">
											<img src="images/gallery_square/17.jpg" alt="image">
										</div>
									</div>
								...
								<!--	<span class="entry-date highlightlinks">
										...
										<h4 class="entry-title">
											<a href="blog-single-right.html" rel="bookmark">Post With Carousel</a>
										</h4>

									</header>
									<!-- .entry-header -->

									<p>Dry waste includes wood and related products, metals and glass. Wet waste, typically refers to organic waste usually generated by eating establishments and are heavy in weight due to dampness. Waste can also be segregated on basis of biodegradable or non-biodegradable waste.
						...
						<!--	<article class="vertical-item content-padding big-padding post format-video with_background rounded">
								...
								<div class="item-content entry-content">
									...
									<span class="entry-date highlightlinks">
										...
										<!--<h4 class="entry-title">
											<a href="blog-single-video-right.html" rel="bookmark">Post With Vimeo Video</a>
										</h4>
							...
							<!--	</div>
								...
								<div class="item-content entry-content">
									...
									<span class="entry-date highlightlinks">
										...
										<h4 class="entry-title">
											<a href="blog-single-video-right.html" rel="bookmark">Post With Youtube Video</a>
										</h4>
							...
							<article class="vertical-item content-padding big-padding post format-aside with_background rounded">
								<div class="item-content entry-content">
									...
									<span class="entry-date highlightlinks">
										...
										<h4 class="entry-title">
											<a href="blog-single-right.html" rel="bookmark">Post Format: Aside</a>
										</h4>
									</header>
									<!-- .entry-header -->
							...
							<article class="vertical-item content-padding text-center ds bg_teaser after_cover darkgrey_bg post format-status">
								...
								<!--	<div class="entry-content">
										<h4 class="entry-title bottommargin_0">
											<a href="blog-single-right.html" rel="bookmark">Post Format: Status</a>
										</h4>
									</div>
									<!-- .entry-content -->
								<!--</div>
							...
							<article class="vertical-item content-padding big-padding post format-link with_background rounded">
								<div class="item-content entry-content">
									...
									<span class="entry-date highlightlinks">
										...
										<h4 class="entry-title bottommargin_0">
											<a href="blog-single-right.html" rel="bookmark">Post Format: Link</a>
										</h4>
							...
							<!--	<div class="item-content entry-content">
									...
									<span class="entry-date highlightlinks">
										...
										<h4 class="entry-title bottommargin_0">
											<a href="blog-single-right.html" rel="bookmark">Post format: Image</a>
										</h4>
					...
					Subscribe to our Newsletter right now to be updated. We promice not to spam!
							...
							<div class="widget widget_recent_posts">
								...
								<ul class="media-list">
									...
									Pork chop filet mignon prosciut ball tip pancetta pork
								</a>
											</h4>
									...
									<li class="media">
										...
										<div class="media-body darklinks">
											<h4 class="poppins">
												<a href="blog-single-left.html">
									Biltong venison beef swine. Corned beef pork ham pork
								</a>
											</h4>
											<span class="entry-date highlight">
												<time class="entry-date" datetime="2017-03-13T08:50:40+00:00">
