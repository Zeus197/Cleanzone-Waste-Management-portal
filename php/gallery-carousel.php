...
<!-- Mirrored from webdesign-finder.com/html/gogreen/gallery-carousel.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 May 2018 04:44:24 GMT -->
<head>
									...
									<ul class="mainmenu nav sf-menu">
										...
										<li>
											...
											<ul>
												...
												<li>
													<a href="blog-full.html">Recycle System</a>
												...
												<li>
													<a href="blog-mosaic.html">Complaint System</a>
												</li>

												<li>
													<a href="blog-single-right.html">Alert System</a>
													
												</li>

												<li>
												
													<a href="blog-single-video-right.html">Rating System</a>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="highlight">Gallery Carousel</h2>
							...
							Home
								...
								<li class="active">Gallery Carousel</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-md-push-1">
							<div id="gallery-owl-carousel" class="owl-carousel dots-center" data-dots="true" data-items="1" data-responsive-lg="1" data-responsive-md="1" data-responsive-sm="1" data-responsive-xs="1">
								...
								<article class="vertical-item content-padding post format-standard with_background rounded">
									...
									Morbi euismod
										...
										<p>
							Vivamus enim justo, suscipit laoreet odio id, interdum egestas sapien. Phasellus ultricies felis lectus, sed condimentum libero condimentum eget.
						</p>
									</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 col-sm-12 text-center">
							<div class="widget">
								<a href="index.html" class="logo bg_logo bottommargin_25">
									<img src="images/logo.png" alt="">
									<span class="logo_text">
