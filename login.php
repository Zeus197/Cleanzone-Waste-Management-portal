...
<!-- Mirrored from webdesign-finder.com/html/gogreen/contact2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 May 2018 04:44:34 GMT -->
<head>
									...
									<ul class="mainmenu nav sf-menu">
										<li class="active">
											...
											<ul>
												...
												<li>
													<a href="main-page.php">Admin Dashboard</a>
												</li>
											</ul>
										</li>
<li>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="highlight">Feedback Form</h2>
					...
					<div class="row topmargin_40">
						<div class="col-sm-12 to_animate">
							<form class="" method="post" action="feedback1db.php">
								<div class="row">
                                ...
                                <textarea aria-required="true" rows="5" cols="45" name="feedback" id="feedback" class="form-control" placeholder="Your Feedback"></textarea>
                            </p>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-12">
										...
										<p class="">
                                <input type="submit"  name="FEED"  VALUE="feed"class="theme_button color1" >Send Feedback</submit>
                            </p>
									</div>
