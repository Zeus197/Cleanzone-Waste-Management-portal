...
$e=mysql_num_rows($t)
			?>
			 <?php
include("database.php");
$n="select * from drycomplaint order by  drycount desc";
$q1=mysql_query($n);
$t1=mysql_fetch_row($q1);
			...
			?>
				 ...
				 <?php
include("database.php");
$nv="select * from dryrecycledb ";
$qv=mysql_query($nv);
echo $yu=mysql_num_rows($qv);
$ts=mysql_fetch_row($qv);
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li><a href="table.php"> <i class="fa fa-table" aria-hidden="true"></i>Dry/Wet Table</a></li>
									...
									<li>
										<a href="#">
											...
											<div class="ca-content">
												<h4 class="ca-main"><?php echo $t1[7];?></h4>
												<h3 class="ca-sub">Dry Wastage</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="#">
										  <i class="fa fa-user" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one"><?php echo $t[7];?></h4>
												<h3 class="ca-sub one">Wet Wastage</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="#">
											...
											<div class="ca-content">
											<h4 class="ca-main two"><?php echo $yu;?></h4>
												<h3 class="ca-sub two">Recycling</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="#">
											...
											<div class="ca-content">
												<h4 class="ca-main three">4</h4>
												<h3 class="ca-sub three">Feedback</h3>
											</div>
										</a>
									</li>
...
<div class="copyrights">
	 <p>© 2017 Esteem. All Rights Reserved | Design by  <a href=""target="_blank">Miet</a> </p>
</div>	
