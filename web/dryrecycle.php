...
<html lang="zxx">
<head>
<title>Waste Management Recycling</title>
<!-- custom-theme -->
...
<div class="wthree_agile_admin_info">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="#"><i class="fa fa-cogs" aria-hidden="true"></i> Recycle Components<i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="dryrecycle.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Recycle Dry Waste</a></li>
										<li class="mini_list_w3"><a href="wetrecycle.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> Recycle wet waste</a></li>
									</ul>
								</li>
								<li>
								...
								<li><a href="table.html"> <i class="fa fa-table" aria-hidden="true"></i> Dry/Wet Table</a></li>
		...
		<!-- /inner_content-->
						...
						<div class="w3l_agileits_breadcrumbs">
							<div class="w3l_agileits_breadcrumbs_inner">
								<ul>
									...
									<li>Recycle Components <span>«</span></li>
									<li>Recycle Dry Waste</li>
								</ul>
							</div>
						</div><br><br><br>
					<!-- //breadcrumbs -->
				...
				<!--	<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Recycle Dry Wastage</h2>
			<!-- /buttons_w3ls_agile -->
								...
								<div class="container">
								<table style="100%">
								<p> <legend>Recycle Dry Wastage</legend></P><br><br>
								<form action="dryrecycledb.php" method="POST">
							
								<table style="50%" cellspacing="5" cellpadding="6">
								
								<tr>
							
								<th><font size="4" font face="Bedrock">Items to be recycled</font></th>
							<th><select id="items recycled" name="itemrecycled">
							<option value="items recycled">---items recycled---</option>
...
<tr><th></th><td height="5px"><input type="hidden"></td></tr><br>
							<tr><th><font size="4" font face="Bedrock">Date </font></th>
								<th><input type="date" name="date" required>		</th>	</tr>	

		
		
		<tr><th><font size="4" font face="Bedrock"><button>Recycle</button></th></tr>
							</table></div>
							</form>
