		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <!--<h2 class="w3_inner_tittle">Recycle wet Wastage</h2>-->
					  
					  <div class="container">
								<table style="100%">
								<p> <legend>Recycle Wet Wastage</legend></P><br><br>
								<form action="wetrecycledb.php" method="POST">
                           ...
                           <option value="Organic food matter">Organic food matter</option>
