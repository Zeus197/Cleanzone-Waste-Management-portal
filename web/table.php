					  ...
					  <h2 class="w3_inner_tittle">Tables</h2>
									...
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">Dry System</h3>
										 
										 <?php
include("database.php");
$r="select * from drycomplaint";
$q=mysql_query($r);
			...
			?>
								...
								<td><?php echo $bb[5];?></td>
								<td><?php echo $bb[6];?></td>
								<td><a href="del.php?id=<?php echo $bb[0];?>">delete</td>
								...
								<div class="w3l-table-info agile_info_shadow">
									  <h3 class="w3_inner_tittle two">Wet System</h3>
									  <?php
include("database.php");
