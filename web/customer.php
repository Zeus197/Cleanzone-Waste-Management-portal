...
<?php
session_start();
echo $uu =$_SESSION['name'];
include("database.php");
$s = "select * from workform where work = '$uu'";
$q = mysql_query($s);
$l = mysql_fetch_row($q);
					...
					<!-- /agile_top_w3_grids-->
					 ...
					 <!-- //agile_top_w3_grids-->
						...
						<!-- //agile_top_w3_post_sections-->
							...
							<h3></h3>
							<h3 class="w3_inner_tittle two"> Work Information of Employee</h3>
							
							
							<table style="width: 1000px" align= "center" cellspacing="0" cellpadding="0" border =1>
						<tr >
